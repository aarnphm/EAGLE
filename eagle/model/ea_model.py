...
class EaModel(nn.Module):
  ...
  def from_pretrained(
    ...
    **kwargs,
    ...
    model = cls(
      use_eagle3, base_model, base_model_path, configpath, total_token, depth, top_k, threshold, ea_layer_state_dict
    )
  ...
  def forward(self, input_ids=None, attention_mask=None, past_key_values=None, output_orig=False, position_ids=None):
  ...
  def eagenerate(
    ...
    for idx in range(max_length):
      ...
      logits, hidden_state_new, outputs = tree_decoding(
        self, draft_tokens, past_key_values, tree_position_ids, input_ids, retrieve_indices
      )
