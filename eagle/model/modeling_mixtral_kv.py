...
MISTRAL_ATTENTION_CLASSES = {'eager': MixtralAttention}
...
@add_start_docstrings(
  'The bare Mixtral Model outputting raw hidden-states without any specific head on top.', MIXTRAL_START_DOCSTRING
)
