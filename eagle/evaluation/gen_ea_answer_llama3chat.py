  ...
  for _ in range(3):
    ...
    for j in range(len(question['turns'])):
      ...
      output_ids, new_token, idx = model.eagenerate(
        torch.as_tensor(input_ids).cuda(), temperature=temperature, log=True, is_llama3=True
      )
      torch.cuda.synchronize()
...
if __name__ == '__main__':
  ...
  parser.add_argument('--base-model-path', type=str, default='/home/lyh/weights/hf/llama31chat/8B/', help='1')
  ...
  parser.add_argument(
    '--total-token', type=int, default=60, help='total-token = The total number of drafted tokens in the tree + 1'
  )
  parser.add_argument('--depth', type=int, default=5, help='depth = The maximum number of draft length - 1')
  parser.add_argument('--top-k', type=int, default=10, help='The maximum number of drafted tokens in each layer.')
