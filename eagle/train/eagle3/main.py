...
if __name__ == '__main__':
  ...
  parser.add_argument(
    ...
    help='Path to the training JSONL file (generated by prepare_mixed_dataset.py).',
  )
  parser.add_argument(
    '--testpath',
    type=str,
    default='eagle/data/eagle3_mixed_ultra_sharegpt.jsonl',
    help='Path to the validation JSONL file. Defaults to the same file as training.',
  )
